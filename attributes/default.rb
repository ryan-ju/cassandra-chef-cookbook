...
default['cassandra']['opscenter']['agent']['local_interface'] = nil # if nil, the parameter will not be set
default['cassandra']['opscenter']['agent']['agent_rpc_interface'] = nil # if nil, the parameter will not be set
default['cassandra']['opscenter']['agent']['agent_rpc_broadcast_address'] = nil # if nil, the parameter will not be set
